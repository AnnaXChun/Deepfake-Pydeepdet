...
if __name__ == '__main__':
    ...
    raw_list_path = os.path.join(args.root_dir, 'fakeimage_list_raw.txt')
    new_list_path = os.path.join(args.save_dir, 'fakeimage_list_raw.txt')
